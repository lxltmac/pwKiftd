...
public class FolderServiceImpl implements FolderService {
	...
	public String newFolder(final HttpServletRequest request) {
		final String parentId = StringUtils.isEmpty(request.getParameter("parentId")) ? (String) request.getAttribute("parentId") : request.getParameter("parentId");
		final String folderName = StringUtils.isEmpty(request.getParameter("folderName")) ? (String) request.getAttribute("folderName") : request.getParameter("folderName");
		final String folderConstraint = StringUtils.isEmpty(request.getParameter("folderConstraint")) ? (String) request.getAttribute("folderConstraint") : request.getParameter("folderConstraint");
		...
		if (account != null) {
			...
			f.setFolderCreatorName(ConfigureReader.instance().getFolderCreatorName(account));
		} else {
			f.setFolderCreator("匿名用户");
			f.setFolderCreatorName("--");
		}
