...
public class HomeController {
	...
	@RequestMapping(value = { "/checkImportFile.ajax" }, produces = { CHARSET_BY_AJAX })
	@ResponseBody
	public String checkImportFile(final HttpServletRequest request, final HttpServletResponse response, final MultipartFile file) throws Exception {
		return this.fis.checkImportFile(request, response, file);
	}
