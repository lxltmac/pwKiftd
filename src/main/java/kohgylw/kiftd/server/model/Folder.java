...
public class Folder
{
    ...
    private String folderCreatorName;
    ...
    public String getFolderCreatorName() {
        return folderCreatorName;
    }

    public void setFolderCreatorName(String folderCreatorName) {
        this.folderCreatorName = folderCreatorName;
    }
}
